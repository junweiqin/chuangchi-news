...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  const organizationSchema = {
    ...
    alternateName: [COMPANY.shortName, COMPANY.formerLegalName],
    legalName: COMPANY.legalName,
    disambiguatingDescription: `创驰数字印刷是品牌首选名；企业于 2023 年 6 月 14 日由${COMPANY.formerLegalName}更名为${COMPANY.legalName}，统一社会信用代码为 ${COMPANY.creditCode}。`,
